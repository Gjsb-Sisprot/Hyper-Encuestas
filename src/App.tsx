...
const badge = (score: string) => {
  ...
  return (
    <span style={{ background: bg, color: fg, border: `1.5px solid ${border}40`, padding: '3px 10px', borderRadius: 99, fontSize: 11, fontWeight: 700, letterSpacing: '.03em', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
      {score}
    </span>
  )
}
...
const leads = [
  ...
  { id:'PA50',  nombre:'Casino Platinum, C.A.',        zona:'Planta Alta',      cat:'Entretenimiento', prov:'Inter',        pago:210, pts:96, score:'A1', plan:'600 Mbps Emp.', feas:'Factible',   accion:'Negociando contrato',   avatar:'CP' },
  { id:'SOT',   nombre:'Hyper Gym, C.A.',              zona:'Sótano',           cat:'Fitness',         prov:'NetUno',       pago:145, pts:94, score:'A1', plan:'600 Mbps Emp.', feas:'Factible',   accion:'Propuesta enviada',     avatar:'HG' },
  { id:'PA04',  nombre:'Hyper Mercado Modelo, C.A.',   zona:'Planta Alta',      cat:'Supermercado',    prov:'Inter',        pago:280, pts:92, score:'A1', plan:'600 Mbps Emp.', feas:'Factible',   accion:'Reunión agendada',      avatar:'HM' },
  { id:'PA01',  nombre:'SISPROT GLOBAL FIBER (SGF)',    zona:'Planta Alta',      cat:'Oficina SGF',     prov:'—',            pago:0,   pts:100,score:'A1', plan:'Punto de venta', feas:'Factible',   accion:'✅ Nuestra oficina en CC', avatar:'SG' },
  { id:'PA07',  nombre:'TU PUNTO SHOP ELECTRONIC',     zona:'Planta Alta',      cat:'Electrónica',     prov:'Fibex',        pago:55,  pts:88, score:'A1', plan:'300 Mbps PYME', feas:'Factible',   accion:'Propuesta enviada',     avatar:'TP' },
  { id:'PB04',  nombre:'Mobile Shop Las Americas',     zona:'Planta Baja',      cat:'Telefonía',       prov:'Datos Móviles',pago:0,   pts:82, score:'A2', plan:'200 Mbps PYME', feas:'Factible',   accion:'Cita agendada',         avatar:'MS' },
  { id:'PA09',  nombre:'Farmacia Malanga, C.A.',       zona:'Planta Alta',      cat:'Farmacia',        prov:'Inter',        pago:48,  pts:80, score:'A2', plan:'200 Mbps PYME', feas:'Factible',   accion:'Propuesta enviada',     avatar:'FM' },
  { id:'PA06',  nombre:'Lotus Beauty Studio, C.A.',    zona:'Planta Alta',      cat:'Belleza/Spa',     prov:'NetUno',       pago:38,  pts:76, score:'A2', plan:'200 Mbps PYME', feas:'Factible',   accion:'Cita agendada',         avatar:'LB' },
  { id:'PA03',  nombre:'KP Zona Digital, C.A.',        zona:'Planta Alta',      cat:'Tecnología',      prov:'Fibex',        pago:42,  pts:74, score:'B',  plan:'100 Mbps PYME', feas:'Factible',   accion:'Seguimiento activo',    avatar:'KP' },
  { id:'PB05',  nombre:'Corporac. Logica Digital CA',  zona:'Planta Baja',      cat:'Tecnología',      prov:'360NET',       pago:35,  pts:71, score:'B',  plan:'100 Mbps PYME', feas:'Factible',   accion:'Primer contacto',       avatar:'CL' },
  { id:'FC01',  nombre:'Joanes Lunch, C.A.',           zona:'Feria de Comida',  cat:'Restaurante',     prov:'Datos Móviles',pago:0,   pts:68, score:'B',  plan:'100 Mbps PYME', feas:'Con Obra',   accion:'Visita técnica pend.',  avatar:'JL' },
  { id:'FC02',  nombre:'Express Hong Kong, C.A.',      zona:'Feria de Comida',  cat:'Rest. Asiática',  prov:'Otro',         pago:22,  pts:65, score:'B',  plan:'100 Mbps PYME', feas:'Con Obra',   accion:'Seguimiento',           avatar:'EH' },
  { id:'FC04',  nombre:'Pizza Mia, C.A.',              zona:'Feria de Comida',  cat:'Pizzería',        prov:'Inter',        pago:30,  pts:62, score:'B',  plan:'100 Mbps PYME', feas:'Factible',   accion:'Seguimiento',           avatar:'PM' },
  { id:'PA02',  nombre:'Lokuras Fashion, C.A.',        zona:'Planta Alta',      cat:'Moda',            prov:'NetUno',       pago:31,  pts:58, score:'C',  plan:'50 Mbps Hogar', feas:'Pendiente',  accion:'Sin contacto aún',      avatar:'LF' },
  { id:'PA08',  nombre:'Venezia Joyas VIP, C.A.',      zona:'Planta Alta',      cat:'Joyería',         prov:'360NET',       pago:28,  pts:55, score:'C',  plan:'50 Mbps Hogar', feas:'Pendiente',  accion:'Revisión técnica',      avatar:'VJ' },
  { id:'PB01',  nombre:'Hyper Joyas, C.A.',            zona:'Planta Baja',      cat:'Joyería',         prov:'Fibex',        pago:25,  pts:52, score:'C',  plan:'50 Mbps Hogar', feas:'Pendiente',  accion:'Sin contacto aún',      avatar:'HJ' },
  { id:'FC07',  nombre:'Shawarma Corner',              zona:'Feria de Comida',  cat:'Rest. Árabe',     prov:'Otro',         pago:18,  pts:44, score:'C',  plan:'50 Mbps Hogar', feas:'Pendiente',  accion:'Sin contacto aún',      avatar:'SC' },
  { id:'PA05',  nombre:'Woman Fit',                    zona:'Planta Alta',      cat:'Fitness/Moda',    prov:'Sin servicio', pago:0,   pts:38, score:'D',  plan:'N/A',           feas:'Pendiente',  accion:'Evaluar',               avatar:'WF' },
  { id:'FC09',  nombre:"L'Artigian, ca.",              zona:'Feria de Comida',  cat:'Rest. Italiana',  prov:'Sin servicio', pago:0,   pts:32, score:'D',  plan:'N/A',           feas:'No Factible', accion:'Descartado',           avatar:'LA' },
  { id:'PB06',  nombre:'Comercializadora Dogs M.',     zona:'Planta Baja',      cat:'Mascotas',        prov:'Sin servicio', pago:0,   pts:28, score:'D',  plan:'N/A',           feas:'No Factible', accion:'Descartado',           avatar:'DM' },
]

// Real C.C. Hiper Jumbo locals from occupancy report — 5 zones
const mapLocals = [
  // PLANTA BAJA — locales PB
  { id:'PB04',  x:38,  y:72,  w:78, h:48, nombre:'Mobile Shop',      score:'A2', vendedor:'Carlos R.' },
  { id:'PB05',  x:124, y:72,  w:78, h:48, nombre:'Logica Digital',   score:'B',  vendedor:'Carlos R.' },
  { id:'PB01',  x:210, y:72,  w:78, h:48, nombre:'Hyper Joyas',      score:'C',  vendedor:'María L.'  },
  { id:'PB06',  x:296, y:72,  w:78, h:48, nombre:'Dogs Market',      score:'D',  vendedor:'María L.'  },
  { id:'PB02',  x:38,  y:130, w:78, h:48, nombre:'Macoba Cafe',      score:'B',  vendedor:'Carlos R.' },
  { id:'PB03',  x:124, y:130, w:78, h:48, nombre:"Tiro D'Eskina",    score:'C',  vendedor:'Pedro M.'  },
  { id:'PB07',  x:210, y:130, w:78, h:48, nombre:'Creativy Space',   score:'B',  vendedor:'Pedro M.'  },
  { id:'PB08',  x:296, y:130, w:78, h:48, nombre:'SATRIM Kiosco',    score:'C',  vendedor:'Ana G.'    },
  // PLANTA ALTA — locales PA
  { id:'PA50',  x:38,  y:248, w:100,h:54, nombre:'Casino Platinum',  score:'A1', vendedor:'Carlos R.' },
  { id:'PA04',  x:148, y:248, w:100,h:54, nombre:'Hyper Mercado',    score:'A1', vendedor:'Carlos R.' },
  { id:'PA07',  x:258, y:248, w:78, h:54, nombre:'Tu Punto Shop',    score:'A1', vendedor:'María L.'  },
  { id:'PA01',  x:344, y:248, w:78, h:54, nombre:'SGF Oficina',      score:'A1', vendedor:'Nuestra oficina' },
  { id:'PA06',  x:38,  y:312, w:78, h:48, nombre:'Lotus Beauty',     score:'A2', vendedor:'Pedro M.'  },
  { id:'PA09',  x:124, y:312, w:78, h:48, nombre:'Farmacia Malanga', score:'A2', vendedor:'María L.'  },
  { id:'PA03',  x:210, y:312, w:78, h:48, nombre:'KP Zona Digital',  score:'B',  vendedor:'Ana G.'    },
  { id:'PA02',  x:296, y:312, w:78, h:48, nombre:'Lokuras Fashion',  score:'C',  vendedor:'Ana G.'    },
  // FERIA DE COMIDA — locales FC
  { id:'FC01',  x:38,  y:432, w:68, h:44, nombre:'Joanes Lunch',     score:'B',  vendedor:'Pedro M.'  },
  { id:'FC02',  x:114, y:432, w:68, h:44, nombre:'Express HK',       score:'B',  vendedor:'Pedro M.'  },
  { id:'FC04',  x:190, y:432, w:68, h:44, nombre:'Pizza Mia',        score:'B',  vendedor:'Ana G.'    },
  { id:'FC07',  x:266, y:432, w:68, h:44, nombre:'Shawarma Corner',  score:'C',  vendedor:'Ana G.'    },
  { id:'FC09',  x:342, y:432, w:68, h:44, nombre:"L'Artigian",       score:'D',  vendedor:'—'         },
  { id:'FC05',  x:418, y:432, w:68, h:44, nombre:'Sazón Express',    score:'B',  vendedor:'Carlos R.' },
]

const scoreHex: Record<string,string> = { A1:'#10B981', A2:'#34D399', B:'#3B82F6', C:'#F59E0B', D:'#EF4444', E:'#CBD5E1' }

// Real data from C.C. Hiper Jumbo — 69,759 m² total, 5 zonas
const provData   = [{ name:'Inter',value:31 },{ name:'NetUno',value:24 },{ name:'Fibex',value:19 },{ name:'360NET',value:12 },{ name:'Datos Móv.',value:8 },{ name:'Otro/Sin',value:6 }]
const prospData  = [{ name:'A1',v:5,c:'#10B981' },{ name:'A2',v:3,c:'#34D399' },{ name:'B',v:6,c:'#3B82F6' },{ name:'C',v:4,c:'#F59E0B' },{ name:'D',v:3,c:'#EF4444' },{ name:'E',v:2,c:'#CBD5E1' }]
const areaData   = [{ d:'Sem 1',s:2 },{ d:'Sem 2',s:5 },{ d:'Sem 3',s:9 },{ d:'Sem 4',s:14 },{ d:'Sem 5',s:18 },{ d:'Sem 6',s:20 }]
    ...
    <div className="app-shell" style={{ display:'flex', height:'100vh', overflow:'hidden', background:'#0A0F1E', fontFamily:'Plus Jakarta Sans, sans-serif' }}>
      ...
      <div style={{ flex:1, overflow:'hidden', display:'flex', flexDirection:'column', minWidth: 0 }}>
        ...
        <header className="top-header" style={{ height:52, background:'#0D1526', borderBottom:`1px solid #1A2540`, display:'flex', alignItems:'center', padding:'0 20px', gap:12, flexShrink:0 }}>
          ...
          <button
            onClick={onOpenSurvey ? onOpenSurvey : () => { window.location.href = '/encuesta' }}
            style={{
  ...
  return (
    <div className="animate-in" style={{ padding:'28px 28px 40px' }}>
        ...
        {kpis.map(k => (
          <div key={k.label} style={{ background:'#111827', border:`1px solid #1F2937`, borderRadius:16, padding:'18px 18px 16px', position:'relative', overflow:'hidden' }}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:10 }}>
              ...
              {k.pct !== null && (
                <span style={{ fontSize:11, fontWeight:700, color:k.color, background:`${k.color}18`, padding:'2px 8px', borderRadius:99 }}>{k.pct}%</span>
              )}
            </div>
            <div style={{ display:'flex', alignItems:'baseline', gap:3, marginBottom:4 }}>
              <span style={{ color:'#F1F5F9', fontSize:28, fontWeight:800, letterSpacing:'-.02em', lineHeight:1 }}>{k.value}</span>
              <span style={{ color:'#475569', fontSize:13, fontWeight:500 }}>{k.total}</span>
            </div>
        ...
        <DarkCard title="Progreso del Censo" sub="Locales encuestados en Supabase">
          <ResponsiveContainer width="100%" height={180}>
            <AreaChart data={areaData} margin={{ top:8, right:8, left:-24, bottom:0 }}>
              ...
              <XAxis dataKey="d" tick={{ fontSize:10, fill:'#4B5563' }} axisLine={false} tickLine={false} />
              <YAxis tick={{ fontSize:10, fill:'#4B5563' }} axisLine={false} tickLine={false} />
              <Tooltip contentStyle={{ background:'#1F2937', border:'none', borderRadius:10, fontSize:12, color:'#F1F5F9' }} cursor={{ stroke:brand, strokeWidth:1, strokeDasharray:'4 2' }} />
              <Area type="monotone" dataKey="s" stroke={brand} strokeWidth={2.5} fill="url(#aGrad)" name="Encuestados" dot={{ r:4, fill:brand, strokeWidth:0 }} activeDot={{ r:6 }} />
            </AreaChart>
          </ResponsiveContainer>
        </DarkCard>
        ...
        <DarkCard title="Mercado ISP Actual" sub="Participación de encuestas reales">
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={provBars} margin={{ top:8, right:4, left:-28, bottom:0 }}>
              ...
              <XAxis dataKey="name" tick={{ fontSize:9.5, fill:'#4B5563' }} axisLine={false} tickLine={false} />
              <YAxis tick={{ fontSize:9.5, fill:'#4B5563' }} axisLine={false} tickLine={false} />
              <Tooltip contentStyle={{ background:'#1F2937', border:'none', borderRadius:10, fontSize:12, color:'#F1F5F9' }} cursor={{ fill:`${brand}10` }} />
              <Bar dataKey="v" radius={[5,5,0,0]} name="% Locales">
                {provBars.map((_,i)=><Cell key={i} fill={i===0?brand:`${brand}${['AA','88','66','44','33'][i-1]??'22'}`} />)}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        </DarkCard>
        ...
        <DarkCard title="Estado del Censo" sub="Estatus general C.C. Hiper Jumbo">
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            <ResponsiveContainer width={120} height={120}>
              <PieChart>
                <Pie data={prospData} cx="50%" cy="50%" innerRadius={36} outerRadius={56} paddingAngle={2} dataKey="v" startAngle={90} endAngle={-270}>
                  {prospData.map((d,i)=><Cell key={i} fill={d.c} />)}
                </Pie>
              </PieChart>
            </ResponsiveContainer>
            <div style={{ flex:1, display:'flex', flexDirection:'column', gap:5 }}>
              {prospData.map(d=>(
                <div key={d.name} style={{ display:'flex', alignItems:'center', gap:7 }}>
                  ...
                  <span style={{ fontSize:11, fontWeight:700, color:'#F1F5F9' }}>{d.v}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div style={{ marginTop:16 }}>
        <DarkCard title="Top Prospectos A1 — Acción Inmediata" sub="Anclas del C.C. Hiper Jumbo · Alta facturación · Factibilidad confirmada">
          <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, marginTop:4 }}>
            {leads.filter(l=>l.score==='A1').map(l=>(
              <div key={l.id} style={{ background:'#0D1526', borderRadius:12, padding:'14px 16px', border:`1px solid #1A2540`, display:'flex', gap:12, alignItems:'center' }}>
                <div style={{ width:40, height:40, borderRadius:10, background:`linear-gradient(135deg,${brand},${cyber})`, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                  <span style={{ color:'#fff', fontWeight:800, fontSize:12 }}>{l.avatar}</span>
                </div>
                <div style={{ flex:1, minWidth:0 }}>
                  <p style={{ color:'#F1F5F9', fontSize:13, fontWeight:600, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{l.nombre}</p>
                  <p style={{ color:'#4B5563', fontSize:11, marginTop:1 }}>{l.zona} · {l.prov}</p>
                  <div style={{ display:'flex', alignItems:'center', gap:6, marginTop:6 }}>
                    {badge(l.score)}
                    <span style={{ fontSize:11, color:'#64748B' }}>{l.pts} pts</span>
                  </div>
                </div>
                <div style={{ textAlign:'right' }}>
                  <p style={{ color:green, fontSize:14, fontWeight:800 }}>${l.pago}</p>
  ...
  return (
    <div style={{ background:'#111827', border:`1px solid #1F2937`, borderRadius:16, padding:'18px 20px' }}>
      <div style={{ marginBottom:14 }}>
        <p style={{ color:'#F1F5F9', fontSize:13, fontWeight:700 }}>{title}</p>
        {sub && <p style={{ color:'#4B5563', fontSize:11, marginTop:2 }}>{sub}</p>}
      </div>
      {children}
    </div>
  )
...
function CRM({ data }: { data?: typeof leads }) {
  ...
  const rows = leadsData.filter(l=>{
    const matchQ = l.nombre.toLowerCase().includes(q.toLowerCase()) || l.id.toLowerCase().includes(q.toLowerCase())
    const matchT = tab==='all' || (tab==='a'&&(l.score==='A1'||l.score==='A2')) || (tab==='b'&&l.score==='B') || (tab==='c'&&(l.score==='C'||l.score==='D'||l.score==='E'))
    return matchQ && matchT
  })

  const tabs: {id:'all'|'a'|'b'|'c'; label:string; count:number}[] = [
    { id:'all', label:'Todos', count:leadsData.length },
    { id:'a',   label:'A1 / A2 — Prioritarios', count:leadsData.filter(l=>l.score==='A1'||l.score==='A2').length },
    { id:'b',   label:'B — Alta Oportunidad', count:leadsData.filter(l=>l.score==='B').length },
    { id:'c',   label:'C / D — Seguimiento', count:leadsData.filter(l=>l.score==='C'||l.score==='D'||l.score==='E').length },
  ]
    ...
    <div className="animate-in" style={{ display:'flex', height:'100%', overflow:'hidden' }}>
      ...
      <div style={{ flex:1, padding:'28px 24px', overflowY:'auto', minWidth:0 }}>
        <div style={{ marginBottom:20 }}>
          <p style={{ color:'#475569', fontSize:11, fontWeight:700, letterSpacing:'.1em', textTransform:'uppercase', marginBottom:4 }}>Pipeline Comercial</p>
          <h1 style={{ color:'#F1F5F9', fontSize:26, fontWeight:800, letterSpacing:'-.02em' }}>Prospectos & Scoring</h1>
        </div>
        ...
        <div style={{ display:'flex', gap:10, marginBottom:20, alignItems:'center' }}>
          <div style={{ position:'relative', flex:1, maxWidth:320 }}>
            ...
            <input value={q} onChange={e=>setQ(e.target.value)} placeholder="Buscar local o nombre..." style={{ width:'100%', background:'#111827', border:`1px solid #1F2937`, borderRadius:10, padding:'9px 12px 9px 36px', color:'#F1F5F9', fontSize:13, outline:'none' }} />
          </div>
          <div style={{ display:'flex', gap:6, background:'#111827', border:`1px solid #1F2937`, borderRadius:10, padding:'4px' }}>
            {tabs.map(t=>(
              <button key={t.id} onClick={()=>setTab(t.id)} style={{ padding:'6px 12px', borderRadius:7, border:'none', background: tab===t.id ? brand : 'transparent', color: tab===t.id ? '#fff' : '#6B7280', fontSize:12, fontWeight:600, cursor:'pointer', transition:'all .15s', whiteSpace:'nowrap' }}>
                {t.label} <span style={{ opacity:.6, fontSize:10, fontWeight:400, marginLeft:2 }}>{t.count}</span>
              </button>
            ))}
          </div>
          <button style={{ background:'transparent', border:`1px solid #1F2937`, color:'#6B7280', borderRadius:10, padding:'8px 14px', fontSize:12, cursor:'pointer' }}>↓ Exportar</button>
        </div>
          ...
          <table style={{ width:'100%', borderCollapse:'collapse' }}>
            <thead>
              <tr style={{ borderBottom:`1px solid #1F2937` }}>
                {['Local','Nombre','Proveedor actual','Pago','Puntaje','Score','Plan SGF','Factibilidad','Acción'].map(h=>(
                  <th key={h} style={{ padding:'11px 16px', textAlign:'left', fontSize:10, fontWeight:700, color:'#374151', letterSpacing:'.07em', textTransform:'uppercase', whiteSpace:'nowrap' }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {rows.map((r,i)=>(
                <tr key={r.id} onClick={()=>setSel(sel?.id===r.id?null:r)} style={{ borderBottom: i<rows.length-1?`1px solid #111827`:'none', background: sel?.id===r.id ? `${brand}12` : 'transparent', cursor:'pointer', transition:'background .1s' }}>
                  <td style={{ padding:'12px 16px' }}>
                    <code style={{ fontSize:11, color:cyber, fontWeight:600, background:'#0D1A36', padding:'2px 8px', borderRadius:5 }}>{r.id}</code>
                  </td>
                  <td style={{ padding:'12px 16px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:9 }}>
                      <div style={{ width:30, height:30, borderRadius:8, background:`${scoreHex[r.score]}22`, border:`1.5px solid ${scoreHex[r.score]}44`, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                        <span style={{ fontSize:10, fontWeight:700, color:scoreHex[r.score] }}>{r.avatar}</span>
                      </div>
                      <div>
                        <p style={{ color:'#F1F5F9', fontSize:13, fontWeight:600, whiteSpace:'nowrap' }}>{r.nombre}</p>
                        <p style={{ color:'#374151', fontSize:10, marginTop:1 }}>{r.zona} · {r.cat}</p>
                      </div>
                    </div>
                  </td>
                  <td style={{ padding:'12px 16px', color:'#6B7280', fontSize:12 }}>{r.prov}</td>
                  <td style={{ padding:'12px 16px' }}>
                    <span style={{ color: r.pago>80?green:r.pago>40?'#F1F5F9':'#6B7280', fontWeight:700, fontSize:13 }}>${r.pago}</span>
                  </td>
                  <td style={{ padding:'12px 16px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                      <div style={{ width:48, height:4, background:'#1F2937', borderRadius:2, overflow:'hidden' }}>
                        <div style={{ width:`${r.pts}%`, height:'100%', background:r.pts>=80?green:r.pts>=60?blue:amber, borderRadius:2 }} />
                      </div>
                      <span style={{ color:'#9CA3AF', fontSize:11, fontWeight:600 }}>{r.pts}</span>
                    </div>
                  </td>
                  <td style={{ padding:'12px 16px' }}>{badge(r.score)}</td>
                  <td style={{ padding:'12px 16px', color:'#6B7280', fontSize:12, whiteSpace:'nowrap' }}>{r.plan}</td>
                  <td style={{ padding:'12px 16px' }}>{feasTag(r.feas)}</td>
                  <td style={{ padding:'12px 16px' }}>
                    <span style={{ fontSize:12, color:'#4B5563' }}>{r.accion}</span>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <p style={{ color:'#374151', fontSize:11, marginTop:12 }}>{rows.length} registros · haz click en una fila para ver el perfil completo</p>
      </div>

      {/* Drawer */}
      {sel && (
        <aside className="animate-in" style={{ width:340, borderLeft:`1px solid #1A2540`, background:'#0D1526', display:'flex', flexDirection:'column', overflow:'hidden', flexShrink:0 }}>
          {/* Drawer header */}
          <div style={{ padding:'24px 22px 20px', background:`linear-gradient(160deg,#0F2D6E,#0D1526)`, position:'relative' }}>
            <button onClick={()=>setSel(null)} style={{ position:'absolute', top:16, right:16, background:'#1E3A5F', border:'none', color:'#6B7280', borderRadius:7, width:28, height:28, cursor:'pointer', fontSize:12, display:'flex', alignItems:'center', justifyContent:'center' }}>✕</button>
            <div style={{ width:48, height:48, borderRadius:12, background:`linear-gradient(135deg,${scoreHex[sel.score]}33,${scoreHex[sel.score]}11)`, border:`2px solid ${scoreHex[sel.score]}44`, display:'flex', alignItems:'center', justifyContent:'center', marginBottom:12 }}>
              <span style={{ color:scoreHex[sel.score], fontWeight:800, fontSize:16 }}>{sel.avatar}</span>
            </div>
            <h3 style={{ color:'#F1F5F9', fontSize:16, fontWeight:700, marginBottom:3 }}>{sel.nombre}</h3>
            <p style={{ color:'#4B5563', fontSize:12 }}>{sel.zona} · {sel.cat}</p>
            <div style={{ display:'flex', gap:7, marginTop:12 }}>
              {badge(sel.score)}
              {feasTag(sel.feas)}
              <span style={{ fontSize:11, color:'#4B5563', background:'#1E2D40', padding:'3px 9px', borderRadius:99 }}>{sel.pts} pts</span>
            </div>
          </div>
          ...
          <div style={{ flex:1, overflowY:'auto', padding:'20px 22px' }}>
            ...
            <DrawerSec title="Historial de Visitas">
              {[{ d:'12 Ago 2026', r:'Completada', e:'Carlos R.' }, { d:'05 Ago 2026', r:'Encargado Ausente', e:'María L.' }].map(v=>(
                <div key={v.d} style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'8px 0', borderBottom:`1px solid #1A2540` }}>
                  <span style={{ color:'#4B5563', fontSize:11 }}>{v.d}</span>
                  <span style={{ color: v.r==='Completada'?green:amber, fontSize:11, fontWeight:600 }}>{v.r}</span>
            ...
            <DrawerSec title="Actividad Reciente">
              {[
                { d:'14 Ago', t:'Propuesta enviada por WhatsApp', dot:brand },
                { d:'10 Ago', t:'Demo de velocidad realizada', dot:cyber },
                { d:'06 Ago', t:'Interés confirmado verbalmente', dot:green },
              ].map(a=>(
                <div key={a.d} style={{ display:'flex', gap:10, padding:'8px 0', borderBottom:`1px solid #1A2540` }}>
                  <div style={{ display:'flex', flexDirection:'column', alignItems:'center', paddingTop:3 }}>
                    <div style={{ width:7, height:7, borderRadius:'50%', background:a.dot, flexShrink:0 }} />
                    <div style={{ width:1, flex:1, background:'#1A2540', marginTop:4 }} />
                  </div>
                  <div style={{ paddingBottom:4 }}>
                    <p style={{ color:'#D1D5DB', fontSize:12 }}>{a.t}</p>
                    <p style={{ color:'#374151', fontSize:10, marginTop:2 }}>{a.d}</p>
                  </div>
                </div>
              ))}
            </DrawerSec>
            ...
            <DrawerSec title="Archivos adjuntos">
              {['Factura Inter Ago 2026.pdf','Foto local entrada.jpg','Propuesta SGF 300 Mbps.pdf'].map(f=>(
                <div key={f} style={{ display:'flex', alignItems:'center', gap:8, padding:'8px 10px', borderRadius:8, background:'#111827', border:`1px solid #1F2937`, marginBottom:6, cursor:'pointer' }}>
                  <span style={{ fontSize:14 }}>{f.endsWith('.pdf')?'📄':'📷'}</span>
                  <span style={{ color:cyber, fontSize:12, flex:1, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{f}</span>
                  <span style={{ color:'#374151', fontSize:10 }}>↓</span>
                </div>
              ))}
            </DrawerSec>

            <button style={{ width:'100%', padding:'12px', borderRadius:10, border:'none', background:`linear-gradient(135deg,${brand},${cyber})`, color:'#fff', fontSize:13, fontWeight:700, cursor:'pointer', boxShadow:`0 4px 16px ${brand}44`, marginTop:4 }}>
...
function StatMini({ label, val, color }: { label:string; val:string; color:string }) {
  return (
    <div style={{ background:'#111827', border:`1px solid #1F2937`, borderRadius:10, padding:'10px 12px' }}>
...
function DrawerSec({ title, children }: { title:string; children:React.ReactNode }) {
  return (
    <div style={{ marginBottom:20 }}>
      <p style={{ color:'#374151', fontSize:10, fontWeight:700, letterSpacing:'.08em', textTransform:'uppercase', marginBottom:10 }}>{title}</p>
      {children}
    </div>
  )
}
function InfoLine({ label, val }: { label:string; val:string }) {
  return (
    <div style={{ display:'flex', justifyContent:'space-between', padding:'6px 0', borderBottom:`1px solid #111827` }}>
      <span style={{ color:'#4B5563', fontSize:12 }}>{label}</span>
      <span style={{ color:'#D1D5DB', fontSize:12, fontWeight:500 }}>{val}</span>
    </div>
  )
}
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            <span style={{ color: cyber, fontSize: 11, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase' }}>C.C. HIPER JUMBO MARACAY</span>
            <span style={{ color: '#334155' }}>•</span>
            <span style={{ color: '#94A3B8', fontSize: 12 }}>Plano Oficial de Ocupación Arquitectónica</span>
          </div>
          <h1 style={{ color: '#F8FAFC', fontSize: 24, fontWeight: 800, letterSpacing: '-.02em' }}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative', width: 220 }}>
            <span style={{ position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)', fontSize: 12, color: '#64748B' }}>🔍</span>
            <input
              value={searchTerm}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
        {floors.map(f => {
          ...
          return (
            <button
              key={f.id}
              onClick={() => { setActiveFloor(f.id); setSelectedUnit(null) }}
              style={{
                background: isAct ? `linear-gradient(135deg, ${f.color}25, rgba(13, 21, 38, 0.9))` : 'rgba(15, 23, 42, 0.6)',
                border: `1.5px solid ${isAct ? f.color : 'rgba(255, 255, 255, 0.08)'}`,
                borderRadius: 14,
                padding: '12px 16px',
                cursor: 'pointer',
                textAlign: 'left',
            ...
            >
              <div>
                <p style={{ color: isAct ? '#F8FAFC' : '#94A3B8', fontSize: 13, fontWeight: 700 }}>{f.label}</p>
                <p style={{ color: isAct ? f.color : '#64748B', fontSize: 10, marginTop: 2 }}>{f.sub}</p>
              </div>
              <span style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 18, flex: 1, minHeight: 520 }}>
              ...
              {currentUnits.map(unit => {
                ...
                return (
                  <g
                    ...
                    onMouseEnter={e => { setHovUnit(unit); setHovPos({ x: e.clientX, y: e.clientY }) }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div className="glass-panel animate-in" style={{ borderRadius: 16, padding: 20, flex: 1, display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                ...
                <button
                  ...
                  style={{ background: 'rgba(255,255,255,0.06)', border: 'none', color: '#94A3B8', borderRadius: 6, width: 26, height: 26, cursor: 'pointer', fontSize: 12 }}
                >
                  ✕
                </button>
              </div>
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
                ...
                <span style={{
                  background: selectedUnit.estado === 'alquilado' ? 'rgba(16,185,129,0.15)' : 'rgba(245,158,11,0.15)',
          ...
          <div className="glass-card" style={{ borderRadius: 16, padding: 16 }}>
            <p style={{ color: '#94A3B8', fontSize: 11, fontWeight: 700, letterSpacing: '.05em', textTransform: 'uppercase', marginBottom: 10 }}>
              Resumen Nivel {activeFloor}
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              <StatMini label="Locales Totales" val={`${totalCount}`} color={cyber} />
              <StatMini label="Ocupación" val={`${Math.round((rentedCount / (totalCount || 1)) * 100)}%`} color={green} />
            </div>
          </div>
        </div>
      </div>
...
function MInput({ label, val, full }: { label:string; val:string; full?:boolean }) {
  return (
    <div style={{ gridColumn: full?'span 2':undefined }}>
      <p style={{ color:muted, fontSize:10, fontWeight:600, marginBottom:4 }}>{label}</p>
      <div style={{ background:'#fff', border:`1.5px solid ${border}`, borderRadius:10, padding:'9px 12px', fontSize:13, color:ink }}>{val}</div>
    </div>
  )
}

function ProgressItem({ label, val, total, color }: { label:string; val:number; total:number; color:string }) {
  return (
    <div>
      <div style={{ display:'flex', justifyContent:'space-between', marginBottom:3 }}>
        <span style={{ color:'#4B5563', fontSize:10 }}>{label}</span>
        <span style={{ color:'#9CA3AF', fontSize:10, fontWeight:600 }}>{val}</span>
      </div>
      <div style={{ height:3, background:'#1F2937', borderRadius:2, overflow:'hidden' }}>
